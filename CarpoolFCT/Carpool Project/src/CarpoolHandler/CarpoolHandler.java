...
public interface CarpoolHandler {
	 ...
	 * @return iterator of rides
	 * @throws NonExistingElementException when does not exist any user with the
	 *                                     given email
	 ...
	 * 
	 * @param email email
	 * @throws AlreadyExistsElementException when there is already a user with the
	 *                                       same email
	 */
	 ...
	 * 
	 * @param email email
	 * @throws NonExistingElementException when there is no user whit the given
	 *                                     email
	 */
	 ...
	 * @throws NonExistingElementException   when there is no ride with the date
	 *                                       from the current user
	 * @throws AlreadyExistsElementException when that ride already has lifts from
	 *                                       other users
	 */
	 ...
	 * @throws NonExistingElementException when the current user does not have any
	 *                                     lifts that day
	 */
	void removeFromRide(Date date) throws InvalidDateException, NonExistingElementException;

	/**
	 * Adds a lift to the current user in the ride of the user with the given email
	 * in the given date
	 * 
	 * @param email email of the user
	 * @param date  date
	 * @return 0 if the user has a seat on the ride or returns the number of users
	 *         waiting for a seat
	 * @throws SameUserException             when the current user and the user whit
	 *                                       the ride are the same
	 * @throws NonExistingElementException   when there is no user with the given
	 *                                       email
	 * @throws InvalidDateException          when the date is invalid
	 * @throws NoRideException               when the user does not have any rides
	 *                                       in that date
	 * @throws AlreadyExistsElementException when the current user already has a
	 *                                       ride or a lift in that date
	 */
	 ...
	 * @throws NonExistingElementException when there is no user with the email
	 *                                     given
	 * @throws InvalidDateException        when the date is invalid
	 */
	...
	/**
	 * Checks if the password given matches the password of the user wiht the given
	 * email
	 * 
	 * @param email    email of the user
	 * @param password password
	 * @param i        number of attempts
	 * @return <code>true</code> if is matches or <code>false</code> if does not
	 *         match
	 * @throws InvalidPasswordException when the number of attempts is exceeded
	 */
