...
public interface Ride {
	...
	/**
	 * Adds a user to ride if the ride is full the user stays in a queue waiting for
	 * a seat in the ride
	 * 
	 * @param user user
	 * @return 0 if the user got a seat in the ride or returns the number of people
	 *         waiting if all the seats are taken
	 */
	int addUser(User user);

	/**
	 * Removes the user from the ride or the waiting line if the user was on the
	 * ride and are users in the queue the first in the queue gets a seat
	 * 
	 * @param user user
	 * @return user removed
	 */
